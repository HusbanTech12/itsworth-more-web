  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="flex items-center gap-2 text-sm text-zinc-400 mb-6 animate-fade-in">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-zinc-900 mb-8 animate-fade-in">
          Sell your {cat.name.replace("Mobile ", "")}
        </h1>

        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {brandList.map((brand, i) => (
            <div key={brand.slug} className="animate-fade-in" style={{ animationDelay: `${i * 0.05}s` }}>
              <BrandCard
                name={brand.name}
