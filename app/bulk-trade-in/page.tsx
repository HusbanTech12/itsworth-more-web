  ...
  return (
    <div className="min-h-screen bg-cream">
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-lime mb-4 animate-fade-in">
            Bulk Trade-In Program
          </p>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight animate-slide-up">
            Sell Electronics <span className="text-lime">in Bulk</span>
          </h1>
          <p className="mt-4 text-lg text-white/80 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.1s" }}>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="text-center mb-12 animate-fade-in">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-orange mb-3">Why Go Bulk</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => (
            <Card key={b.title} padding="lg" className="text-center hover:shadow-lg hover:-translate-y-0.5 hover:border-orange/20 transition-all duration-300 animate-slide-up group" style={{ animationDelay: `${i * 0.08}s` }}>
              <div className="w-12 h-12 rounded-xl bg-orange/10 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:bg-orange/15 transition-all duration-300">
                {b.icon}
              </div>
      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="space-y-3 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          {faqs.map((faq) => (
            <Card key={faq.q} padding="md" className="hover:shadow-md hover:border-orange/20 transition-all duration-300">
              <h3 className="font-semibold text-ink text-sm">{faq.q}</h3>
