  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-zinc-900">Newsletter Subscriptions</h1>
        <span className="text-sm text-zinc-500">{items.length} subscribers</span>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-zinc-50 border-b border-zinc-200">
                ...
                <th className="text-left px-4 py-3 font-medium text-zinc-500">Locale</th>
              ...
              {items.length === 0 ? (
                ...
                items.map((item, i) => (
                  <tr key={item.id} className={i % 2 === 0 ? "bg-white" : "bg-zinc-50/50"}>
                    ...
                    <td className="px-4 py-3 font-medium text-zinc-900">{item.email}</td>
