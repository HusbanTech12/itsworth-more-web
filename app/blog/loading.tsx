export default function BlogLoading() {
  return (
    <div className="min-h-screen bg-white">
      <div className="bg-white text-zinc-900 py-12 lg:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="h-3 w-16 bg-zinc-100 rounded animate-pulse mx-auto mb-4" />
          <div className="h-10 w-64 bg-zinc-100 rounded animate-pulse mx-auto mb-4" />
          <div className="h-5 w-96 bg-zinc-100 rounded animate-pulse mx-auto" />
        </div>
      </div>
