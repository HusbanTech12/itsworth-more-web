      ...
      <div className="border-b border-zinc-100">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-2 text-xs text-zinc-400 mb-4">
            ...
            <span>/</span>
            <span className="text-zinc-900 font-medium truncate">{post.title}</span>
          </div>
          ...
          <p className="text-sm text-zinc-400 mt-3">{post.date}</p>
        </div>
      </div>

      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="aspect-[16/9] rounded-2xl overflow-hidden bg-zinc-50 mb-10">
          <img
            src={post.image}
            alt={post.title}
