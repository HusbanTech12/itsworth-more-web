  ...
  return (
    <footer className="bg-ink">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="mt-6 pt-4 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 items-center gap-6">
          <p className="text-sm text-white/40 text-center sm:col-start-2">
            &copy; 2012&ndash;2026 CashingTech.com LLC &mdash; All rights reserved
          </p>
